        ...
        <div className="text-justify">
            ...
            <div className="m-2">
                ...
                <ul className="mx-1 list-disc list-inside">
                    ...
                    <li>
                        <strong>Data Scientist Intern</strong> - Sao Paulo, SP
                        (Jan 2022 – Apr 2022)
                        <ul>
                            <li>
                                Worked in data engineering, experimenting with
                                AI models
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                Worked on production-scale systems in a Scrum
                                team
                            </li>
                        </ul>
                    </li>
            ...
            <div className="m-2">
                ...
                <ul className=" mx-1 list-disc list-inside">
                    <li>
                        <strong>Languages:</strong> Python, Java, Kotlin, C#,
                    ...
                    <li>
                        <strong>Proficiencies:</strong> Software Engineering,
                        Cloud Computing, System Architecture, Machine Learning,
